...
class Prediction: 
    ...
    def predict_calls(self, df):
        ...
        nm_calls_norm_dist = df['NumCalls (Normal dist.)']
        nm_calls_norm_dist[nm_calls_norm_dist < 0] = 0 # because we dont want a negative number of calls on a given day
        df['NumCalls (Normal dist.)'] = nm_calls_norm_dist
        # num = df._get_numeric_data() # get values of the df that are negative
        # num[num < 0] = 0 #substitutes them by 0
